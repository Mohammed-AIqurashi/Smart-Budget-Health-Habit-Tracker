...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50/60 via-white to-indigo-50/60 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 p-4 py-8 transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in">
        ...
        <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl border border-gray-100 dark:border-gray-800/90 shadow-xl rounded-3xl p-7 sm:p-8">
          <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-6">{t('signUp')}</h2>
