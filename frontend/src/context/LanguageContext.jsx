...
const translations = {
  en: {
    ...
    habitsSummary: 'Habits Summary', todayFilter: 'Today', allTimeFilter: 'All Time', customRangeFilter: 'Custom Range',
    ...
    dailyScoreTitle: 'Daily Health Score',
    cutting: 'Cutting', bulking: 'Bulking',
    fitnessMode: 'Fitness Goal', fitnessModeTip: 'Affects how calories and macros are evaluated in your daily score',
    scoreLegend: 'Dynamic score calculated from your active goals only',
    perfectDayFeedback: '🔥 Outstanding day! Complete commitment to your goals. Keep this momentum!',
    goodDayFeedback: '💪 Great performance today! You achieved most of your targets.',
    needProteinFeedback: '🥩 Good effort, but your protein is still low today. Nourish your muscles!',
    exceededCaloriesFeedback: '⚠️ You exceeded your calorie limit for cutting today. Keep it in check tomorrow!',
    needCaloriesFeedback: '🍽️ You are below your bulking calorie target. Eat more to support muscle growth!',
    needWaterFeedback: '💧 Don’t forget your hydration! Drink more water to hit your target.',
    needSleepFeedback: '😴 Make sure to get adequate sleep tonight for proper recovery.',
    needStepsFeedback: '👟 Keep moving! You have not reached your steps goal yet.',
    noDataDayFeedback: '📝 No health logs recorded for this day yet. Start logging your calories & habits!',
    lowScoreFeedback: '⚡ You fell short on several goals today. Tomorrow is a fresh start to crush it!',
    ...
    time: 'Time', autoTime: 'Current Time (Auto)', customTime: 'Specify Time',
    ...
    waterGoal: 'Target Water (ml)', stepsGoal: 'Target Steps', sleepGoal: 'Target Sleep (hours)',
  ...
  ar: {
    ...
    habitsSummary: 'ملخص العادات والمؤشرات', todayFilter: 'اليوم', allTimeFilter: 'جميع الأيام', customRangeFilter: 'فترة محددة',
    ...
    dailyScoreTitle: 'تقييم الأداء الصحي اليومي',
    cutting: 'تنشيف ✂️', bulking: 'تضخيم 💪',
    fitnessMode: 'الهدف الرياضي', fitnessModeTip: 'يحدد طريقة احتساب السعرات والماكروز في تقييمك اليومي',
    scoreLegend: 'سكور ديناميكي محسوب فقط من الأهداف التي قمت بتفعيلها',
    perfectDayFeedback: '🔥 يوم أسطوري! التزام حديدي بكل أهدافك اليوم، استمر على هذا المستوى الرائع!',
    goodDayFeedback: '💪 أداء رائع اليوم! حققت معظم أهدافك المقررة بنجاح.',
    needProteinFeedback: '🥩 نسبة البروتين منخفضة اليوم، احرص على تناول وجبة غنية بالبروتين لتغذية عضلاتك!',
    exceededCaloriesFeedback: '⚠️ تجاوزت سقف سعرات التنشيف اليوم. حاول موازنتها والالتزام غداً!',
    needCaloriesFeedback: '🍽️ سعراتك أقل من المطلوب للتضخيم اليوم، زِد كمية وجباتك لدعم البناء والنمو!',
    needWaterFeedback: '💧 شرب الماء قليل اليوم! حافظ على ترطيب جسمك واشرب المزيد من الماء.',
    needSleepFeedback: '😴 ساعات نومك غير كافية اليوم! احرص على نيل قسط وافٍ من الراحة للاستشفاء.',
    needStepsFeedback: '👟 خطواتك قليلة اليوم! تحرك أكثر واقترب من هدفك اليومي.',
    noDataDayFeedback: '📝 لم تسجل أي عادات أو سعرات لهذا اليوم حتى الآن. ابدأ بتسجيل يومك!',
    lowScoreFeedback: '⚡ أداؤك بعيد عن أهدافك اليوم. غداً بداية جديدة لتقفيل كل الأهداف بقوة!',
    ...
    time: 'الوقت', autoTime: 'الوقت الحالي (تلقائي)', customTime: 'تحديد وقت',
    ...
    waterGoal: 'هدف الماء اليومي (مل)', stepsGoal: 'هدف الخطوات اليومي', sleepGoal: 'هدف النوم اليومي (ساعات)',
